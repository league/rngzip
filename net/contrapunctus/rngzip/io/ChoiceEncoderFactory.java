 ...
 * <code>ChoiceEncoder</code> objects.
 * 
 ...
 */
public interface ChoiceEncoderFactory
{
   /**
    * Create an encoder representing a choice point with up to ‘limit’
    * possible choices.
    *
    ...
    */
   ChoiceEncoder makeChoiceEncoder(int limit, Object id);
}
